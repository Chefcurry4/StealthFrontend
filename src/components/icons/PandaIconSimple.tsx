interface PandaIconSimpleProps {
  size?: number;
  className?: string;
}

// Panda icon without X eyes - for AI workbench
export const PandaIconSimple = ({ size = 24, className = "" }: PandaIconSimpleProps) => {
  return (
    <svg 
...
export default PandaIconSimple;
