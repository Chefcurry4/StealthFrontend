...
const MASTER_STRUCTURES: Record<string, any> = {
  ...
  "3d6ebdf3-45ba-479f-a5eb-1fd80232027e": {
    ...
    optionCourses: [
      ...
      { name: "Ergodic theory", credits: 5, specializations: ["AG"] },
      ...
      { name: "Riemann surfaces", credits: 5, specializations: ["AG"] },
      ...
      // Algorithmic and Discrete Mathematics track
      { name: "Algebraic methods in combinatorics", credits: 5, specializations: ["AD"] },
      { name: "Diophantine approximation", credits: 5, specializations: ["AD"] },
      { name: "Integer optimisation", credits: 5, specializations: ["AD"] },
      { name: "Mathematical modeling of behavior", credits: 5, specializations: ["AD"] },
      { name: "Metric embeddings", credits: 5, specializations: ["AD"] },
      { name: "Probabilistic methods in combinatorics", credits: 5, specializations: ["AD"] },
      // Analysis track
      { name: "Calculus of variations", credits: 5, specializations: ["AN"] },
      { name: "Dispersive PDEs", credits: 5, specializations: ["AN"] },
      { name: "Distribution and interpolation spaces", credits: 5, specializations: ["AN"] },
      { name: "Harmonic analysis", credits: 5, specializations: ["AN"] },
      { name: "Introduction to dynamical systems", credits: 5, specializations: ["AN"] },
      { name: "Lattice models", credits: 5, specializations: ["AN"] },
      { name: "Nonlinear Schrödinger equations", credits: 5, specializations: ["AN"] },
      { name: "Optimal transport", credits: 5, specializations: ["AN"] },
      { name: "Spectral theory", credits: 5, specializations: ["AN"] },
      // Numerical Analysis track
      { name: "Computational linear algebra", credits: 5, specializations: ["NA"] },
      { name: "Computational optimal transport", credits: 5, specializations: ["NA"] },
      { name: "Error control in scientific modeling", credits: 5, specializations: ["NA"] },
      { name: "HPC for numerical methods and data analysis", credits: 5, specializations: ["NA"] },
      { name: "Kinetic and non-equilibrium conservation laws", credits: 5, specializations: ["NA"] },
      { name: "Numerical integration of dynamical systems", credits: 5, specializations: ["NA"] },
      { name: "Numerical integration of stochastic differential equations", credits: 5, specializations: ["NA"] },
      { name: "Numerics for fluids, structures and electromagnetics", credits: 5, specializations: ["NA"] },
      { name: "Optimization on manifolds", credits: 5, specializations: ["NA"] },
      { name: "Randomized matrix computations", credits: 5, specializations: ["NA"] },
      { name: "Stochastic simulation", credits: 5, specializations: ["NA"] },
      { name: "Topics in machine learning", credits: 5, specializations: ["NA"] },
      // Probability and Statistics track
      { name: "Advanced stochastic analysis", credits: 5, specializations: ["PS"] },
      { name: "Applied biostatistics", credits: 5, specializations: ["PS"] },
      { name: "Applied statistics", credits: 5, specializations: ["PS"] },
      { name: "Biostatistics", credits: 5, specializations: ["PS"] },
      { name: "Cellular automata and models of artificial life", credits: 5, specializations: ["PS"] },
      { name: "Concentration of measures", credits: 5, specializations: ["PS"] },
      { name: "Empirical processes", credits: 5, specializations: ["PS"] },
      { name: "Foundations of probabilistic proofs", credits: 6, specializations: ["PS"] },
      { name: "Gaussian processes", credits: 5, specializations: ["PS"] },
      { name: "Introduction to multi-scale stochastic dynamics", credits: 6, specializations: ["PS"] },
      { name: "Introduction to random geometry", credits: 5, specializations: ["PS"] },
      { name: "Introduction to stochastic PDEs", credits: 5, specializations: ["PS"] },
      { name: "Large deviations", credits: 5, specializations: ["PS"] },
      { name: "Martingales in financial mathematics", credits: 5, specializations: ["PS"] },
      { name: "Multivariate statistics", credits: 5, specializations: ["PS"] },
      { name: "Nonparametric estimation and inference", credits: 5, specializations: ["PS"] },
      { name: "Probabilistic models of modern AI", credits: 5, specializations: ["PS"] },
      { name: "Regression methods", credits: 5, specializations: ["PS"] },
      { name: "Statistical analysis of network data", credits: 5, specializations: ["PS"] },
      { name: "Statistical computation and visualisation", credits: 5, specializations: ["PS"] },
      { name: "Statistical inference", credits: 5, specializations: ["PS"] },
      { name: "Statistical machine learning", credits: 5, specializations: ["PS"] },
      { name: "Statistical mechanics and Gibbs measures", credits: 5, specializations: ["PS"] },
      { name: "Statistical theory", credits: 5, specializations: ["PS"] },
      { name: "Statistics for genomic data analysis", credits: 5, specializations: ["PS"] },
      { name: "Theory of stochastic calculus", credits: 5, specializations: ["PS"] },
      { name: "Topics in high-dimensional probability", credits: 5, specializations: ["PS"] },
      // Other courses
      { name: "Gödel and recursivity", credits: 5, specializations: [] },
      { name: "Set theory", credits: 5, specializations: [] },
    ],
    transversalCourses: [
  ...
  "0df709e6-e544-49dc-aa76-0e1bc95ef38c": {
    // DS (Data Science)
    structure: {
      total_credits: 120,
      duration: "2 years",
      contact_email: "eileen.hazboun@epfl.ch",
      website: "go.epfl.ch/master-data-science",
      internship_note: "The program includes a compulsory internship of eight weeks during the summer, or six months during the semester. The internship can also be combined with the master's thesis.",
    },
    components: [
      { name: "Master's Thesis", credits: 30, color: "hsl(var(--chart-1))" },
      { name: "Core Courses", credits: 32, color: "hsl(var(--chart-2))" },
      { name: "Options", credits: 40, color: "hsl(var(--chart-3))" },
      { name: "Research Project", credits: 12, color: "hsl(var(--chart-4))" },
      { name: "SHS Project", credits: 6, color: "hsl(var(--chart-5))" },
    ],
    specializations: [],
    coreCourses: [
      { name: "Algorithms II", credits: 8, specializations: [] },
      { name: "Applied data analysis", credits: 8, specializations: [] },
      { name: "Foundations of data science", credits: 8, specializations: [] },
      { name: "Information security and privacy", credits: 8, specializations: [] },
      { name: "Machine learning", credits: 8, specializations: [] },
      { name: "Modern natural language processing", credits: 8, specializations: [] },
      { name: "Optimization for machine learning", credits: 8, specializations: [] },
      { name: "Systems for data management and data science", credits: 8, specializations: [] },
    ],
    optionCourses: [
      { name: "Advanced compiler construction", credits: 6, specializations: [] },
      { name: "Advanced cryptography", credits: 6, specializations: [] },
      { name: "Advanced probability and applications", credits: 8, specializations: [] },
      { name: "Advanced topics on privacy enhancing technologies", credits: 8, specializations: [] },
      { name: "AI product management", credits: 6, specializations: [] },
      { name: "Applied biostatistics", credits: 5, specializations: [] },
      { name: "Automatic speech processing", credits: 4, specializations: [] },
      { name: "Basics of mobile robotics", credits: 4, specializations: [] },
      { name: "Causal inference", credits: 4, specializations: [] },
      { name: "Causal thinking", credits: 5, specializations: [] },
      { name: "Computational complexity", credits: 6, specializations: [] },
      { name: "Computational linear algebra", credits: 5, specializations: [] },
      { name: "Computational neuroscience: neural dynamics", credits: 5, specializations: [] },
      { name: "Computer vision", credits: 6, specializations: [] },
      { name: "Computers and music", credits: 6, specializations: [] },
      { name: "Concurrent computing", credits: 6, specializations: [] },
      { name: "Cryptography and security", credits: 8, specializations: [] },
      { name: "Data visualization", credits: 6, specializations: [] },
      { name: "Deep learning", credits: 4, specializations: [] },
      { name: "Deep learning in biomedicine", credits: 6, specializations: [] },
      { name: "Deep reinforcement learning", credits: 6, specializations: [] },
      { name: "Digital education", credits: 6, specializations: [] },
      { name: "Distributed algorithms", credits: 8, specializations: [] },
      { name: "Distributed information systems", credits: 6, specializations: [] },
      { name: "Ethics and law of AI", credits: 4, specializations: [] },
      { name: "Formal verification", credits: 8, specializations: [] },
      { name: "Foundation models and generative AI", credits: 6, specializations: [] },
      { name: "Geometric computing", credits: 8, specializations: [] },
      { name: "Graph theory", credits: 5, specializations: [] },
      { name: "Image analysis and pattern recognition", credits: 4, specializations: [] },
      { name: "Image processing I", credits: 3, specializations: [] },
      { name: "Image processing II", credits: 3, specializations: [] },
      { name: "Information theory and coding", credits: 8, specializations: [] },
      { name: "Interaction design", credits: 6, specializations: [] },
      { name: "Interactive theorem proving", credits: 8, specializations: [] },
      { name: "Introduction to natural language processing", credits: 6, specializations: [] },
      { name: "Introduction to quantum cryptography", credits: 6, specializations: [] },
      { name: "Large-scale data science for real-world data", credits: 6, specializations: [] },
      { name: "Learning in neural networks", credits: 6, specializations: [] },
      { name: "Learning theory", credits: 6, specializations: [] },
      { name: "Linear models", credits: 5, specializations: [] },
      { name: "Machine learning for behavioral data", credits: 6, specializations: [] },
      { name: "Management de projet et analyse du risque", credits: 4, specializations: [] },
      { name: "Markov chains and algorithmic applications", credits: 6, specializations: [] },
      { name: "Mathematics of data: from theory to computation", credits: 6, specializations: [] },
      { name: "Network machine learning", credits: 4, specializations: [] },
      { name: "Networks out of control", credits: 6, specializations: [] },
      { name: "Optional research project in data science", credits: 8, specializations: [] },
      { name: "Regression methods", credits: 5, specializations: [] },
      { name: "Secure hardware design", credits: 6, specializations: [] },
      { name: "Software security", credits: 8, specializations: [] },
      { name: "Statistical inference", credits: 5, specializations: [] },
      { name: "Statistical theory", credits: 5, specializations: [] },
      { name: "Student seminar: security protocols and applications", credits: 3, specializations: [] },
      { name: "Sublinear algorithms for big data analysis", credits: 6, specializations: [] },
      { name: "Time series", credits: 5, specializations: [] },
      { name: "Topics in theoretical computer science", credits: 6, specializations: [] },
      { name: "Visual intelligence", credits: 6, specializations: [] },
    ],
    minors: [
